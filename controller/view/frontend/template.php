...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <select class="form-control" id="id_base" name="id_base"  onchange="this.form.submit()">
          <option value="<?= $_SESSION['activebase']?>"> <?=$_SESSION['activebasename']?></option>
          <option> </option>
          <?php
        ...
        <?php endforeach;?>
                        ...
                        <li class="nav-item dropdown notification">
                            <a class="nav-link nav-icons" href="index.php?action=cron" id="navbarDropdownMenuLink1"  aria-haspopup="true" aria-expanded="false"><i class=" fas fa-sync"></i> </a>                        
                        </li>
    ...
    <script>$('[name="id_base"]').change(function() {
