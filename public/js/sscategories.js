...
{      
	$.ajax({
		url: 'index.php?module=sscategories&action=update',
		type: 'POST',
		dataType: "html",
	   		data: {
...
{ 
	this.editableGrid = new EditableGrid("sscategories", {
      enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("index.php?module=sscategories&action=loaddata");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Voulez vous bien suprimer la transaction ' + id )  ) {
        ...
        $.ajax({
		url: 'index.php?module=sscategories&action=delete',
		type: 'POST',
		dataType: "html",
		data: {
...
DatabaseGrid.prototype.addRow = function(id) 
{
  ...
  var self = this;
        ...
        $.ajax({
		url: 'index.php?module=sscategories&action=add',
		type: 'POST',
		dataType: "html",
		data: {
			tablename : self.editableGrid.name,
			name:  $("#name").val(),
			id_category_parent:  $("#id_category_parent").val(),
		},
		success: function (response) 
		{ 
			if (response == "ok" ) {
