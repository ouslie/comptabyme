...
var id_notefrais = $_GET('id_notefrais');
...
function updateCellValue(editableGrid, rowIndex, columnIndex, oldValue, newValue, row, onResponse) {
	$.ajax({
		url: 'index.php?module=frais_items&action=update&id_notefrais='+id_notefrais,
		type: 'POST',
		dataType: "html",
		data: {
...
function DatabaseGrid() {
	this.editableGrid = new EditableGrid("frais_items", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function () {
	...
	this.editableGrid.loadJSON("index.php?module=frais_items&action=loaddata&id_notefrais="+id_notefrais);
};
...
DatabaseGrid.prototype.deleteRow = function (id) {
	...
	if (confirm('Voulez vous bien suprimer la transaction ' + id)) {
		...
		$.ajax({
			url: 'index.php?module=frais_items&action=delete&id_notefrais='+id_notefrais,
			type: 'POST',
			dataType: "html",
			data: {
...
DatabaseGrid.prototype.addRow = function (id) {
	...
	$.ajax({
		url: 'index.php?module=frais_items&action=add&id_notefrais='+id_notefrais,
		type: 'POST',
		dataType: "html",
		data: {
			tablename: self.editableGrid.name,
			date: $("#date").val(),
			id_category_child_frais: $("#id_category_child_frais").val(),
			third: $("#third").val(),
			amount: $("#amount").val(),
			id_bank: $("#id_bank").val(),
		},
