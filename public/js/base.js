...
{      
	$.ajax({
		url: 'index.php?module=base&action=update',
		type: 'POST',
		dataType: "html",
	   		data: {
...
{ 
	this.editableGrid = new EditableGrid("base", {
      enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("module/base/loaddata.php?db_tablename=base");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Voulez vous bien suprimer la transaction ' + id )  ) {
        ...
        $.ajax({
		url: 'index.php?module=base&action=delete',
		type: 'POST',
		dataType: "html",
		data: {
...
DatabaseGrid.prototype.addRow = function(id) 
{
  ...
  var self = this;
        ...
        $.ajax({
		url: 'index.php?module=base&action=add',
		type: 'POST',
		dataType: "html",
		data: {
